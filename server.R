...
#UNDER DEVELOPMENT - use only sample xlsx (table_to_update_DB.xlsx)
...
observeEvent(input$ana_upd_submitAB,{
  ...
  ana_upd_loadedxlsx <- read_excel(ana_upd_xlsFileName()$datapath,col_names = FALSE,col_types=c(rep("text",each=9),"date",rep("text",each=39)))
